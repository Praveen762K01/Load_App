...
class LocalUserData {
  ...
  final String id, name, photoURL, aboutUser, secondaryName;
  ...
  factory LocalUserData.fromJson(Map<String, dynamic> jsonData) {
    return LocalUserData(
      ...
      secondaryName: jsonData["secondaryName"],
    );
  }
...
//-------
  ...
  Future<Map<String?, String?>> getContacts(
    ...
    LoadApp.checkAndRequestPermission(Permission.contacts).then((res) {
      if (res) {
        ...
        LoadApp.showRationale(getTranslated(context, 'perm_contact'));
      ...
      LoadApp.showRationale('Error occured: $onError');
    });
    notifyListeners();
    ...
    if (existingPrefs.getString('lastTimeCheckedContactBookSavedCopy') ==
      ...
      contactsBookContactList!.forEach((key, value) async {
        if ((previouslyFetchedKEYPhoneInSharedPrefs
          ...
          await FirebaseFirestore.instance
            ...
            if (docs.docs.length > 0) {
              ...
              if (key == contactsBookContactList!.entries.last.key) {
                ...
                searchingcontactsindatabase = false;
                LoadApp.toast('Contact Book Empty');
                notifyListeners();
          ...
          //     notifyListeners();
          //     LoadApp.toast(
          //         '2. SEARCH COMPLETED , ${alreadyJoinedSavedUsersPhoneNameAsInServer.length} CONTACTS EXISTS IN DATABASE');
          //     final StatusProvider statusProvider =
          //         Provider.of<StatusProvider>(context, listen: false);
          //     await statusProvider.searchContactStatus(
          //         currentuserphone, alreadyJoinedSavedUsersPhoneNameAsInServer);
          //   }
          // }
        } else {
