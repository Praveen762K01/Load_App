...
class LoadApp {
  ...
  static void invite(BuildContext context) {
    ...
    String multilingualtext = Platform.isIOS
        ...
        : '${getTranslated(context, 'letschat')} $Appname, ${getTranslated(context, 'joinme')} -  https://play.google.com/store/apps/details?id=www.loadapp.com';
        ...
        return (user[Dbkeys.photoUrl] ?? '').isNotEmpty
            ...
            : CircleAvatar(
                ...
                child: Text(predefinedinitials ??
                    getInitials(LoadApp.getNickname(user)!)),
                radius: radius,
              );
      return CircleAvatar(
