...
import '../../profile_settings/profile_view.dart';
import '../../status/components/formatStatusTime.dart';
                                      ...
                                      return InkWell(
                                        ...
                                        child: Container(
                                          width: MediaQuery.of(context)
                                              ...
                                              0.67,
                                          child: Text(
                                            snapshot.data?.secondaryName !=
                                                        null &&
                                                    snapshot.data
                                                            ?.secondaryName !=
                                                        ''
                                                ? '$postedbyname $postedbyphone (${snapshot.data?.secondaryName}) '
