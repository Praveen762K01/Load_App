...
import '../../Screens/Groups/GroupDetails.dart';
...
class _GroupChatPageState extends State<GroupChatPage>
  ...
  List<FlutterSoundPlayer>? _mPlayerList = [];
  Map _mPlayerMapping = {};
  @override
  void initState() {
    super.initState();
...
//       //----sharing intent action:
  ...
  buildEachMessage(Map<String, dynamic> doc, GroupModel groupData, int index) {
    if (doc[Dbkeys.groupmsgTYPE] == Dbkeys.groupmsgTYPEnotificationAddedUser) {
      ...
      return doc[Dbkeys.content] == null || doc[Dbkeys.content] == ''
          ? buildMediaMessages(doc, groupData, index)
          : Dismissible(
              ...
              child: buildMediaMessages(doc, groupData, index));
    }
  ...
  Widget buildMediaMessages(
      Map<String, dynamic> doc, GroupModel groupData, int index) {
                    ...
                    : doc[Dbkeys.messageType] == MessageType.text.index
                        ...
                        : doc[Dbkeys.messageType] == MessageType.location.index
                            ...
                            : doc[Dbkeys.messageType] == MessageType.doc.index
                                ...
                                : doc[Dbkeys.messageType] ==
                                        MessageType.audio.index
                                    ? getAudiomessage(context,
                                        doc[Dbkeys.content], doc, index,
  ...
  Widget getAudiomessage(
      BuildContext context, String message, Map<String, dynamic> doc, int index,
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: MultiPlayback(
              isMe: isMe,
              mPlayer1: _mPlayerList!.length > _mPlayerMapping[index]
                  ? _mPlayerList![_mPlayerMapping[index]]
                  : null,
                    ...
                    InfiniteCOLLECTIONListViewWidget(
                      ...
                      list: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int i) {
                            ...
                            if (dc[Dbkeys.messageType] ==
                                MessageType.audio.index) {
                              _mPlayerList?.add(FlutterSoundPlayer());
                              _mPlayerMapping[i] = m;
                              m++;
                            }
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: LoadApp.getNTPWrappedWidget(Consumer<List<GroupModel>>(
