...
class _SecurityState extends State<Security> {
  ...
  Widget build(BuildContext context) {
    return LoadApp.getNTPWrappedWidget(Stack(children: [
      Scaffold(
                    ...
                    if (widget.setPasscode) {
                      ...
                      if (
                        ...
                        var data = {
                          ...
                          // ANSWER:
                          //     LoadApp.getHashedAnswer(_answer.text),
                          Dbkeys.passcode: LoadApp.getHashedString(_passCode!)
                        };
                        setState(() {
                          isLoading = true;
                        });
