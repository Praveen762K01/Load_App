...
class LoginScreenState extends State<LoginScreen>
  ...
  Future<void> verifyPhoneNumber() async {
    ...
    final PhoneVerificationFailed verificationFailed =
      ...
      LoadApp.toast('Authentication failed - ${authException.message}');
    };
    ...
    final PhoneCodeAutoRetrievalTimeout codeAutoRetrievalTimeout =
      ...
      if (mounted) {
        ...
        LoadApp.toast('Authentication failed Timeout. please try again.');
      }
    };
    ...
    // } catch (e) {
    //   LoadApp.toast('NEW CATCH' + e.toString());
    // }
  }
  ...
  Future<Null> handleSignIn({AuthCredential? authCredential}) async {
    ...
    try {
      ...
      if (firebaseUser != null) {
        ...
        if (documents.length == 0) {
          ...
          if (fcmTokenn != null) {
            ...
            LoadApp.toast(getTranslated(this.context, 'failedtologin'));
          }
        } else {
          ...
          if (fcmToken != null) {
            ...
            unawaited(Navigator.pushReplacement(
                ...
                new MaterialPageRoute(
                    builder: (context) => FiberchatWrapper())));
            LoadApp.toast(getTranslated(this.context, 'welcomeback'));
          } else {
            unawaited(Navigator.pushReplacement(
                this.context,
                new MaterialPageRoute(
                    builder: (context) => FiberchatWrapper())));
            LoadApp.toast(getTranslated(this.context, 'failedlogin'));
          }
        }
      } else {
        LoadApp.toast(getTranslated(this.context, 'failedlogin'));
      ...
      if (e.toString().contains('invalid') ||
        ...
        LoadApp.toast(getTranslated(this.context, 'makesureotp'));
      }
    }
  }
              ...
              child: PinFieldAutoFill(
                ...
                onCodeSubmitted: (code) {
                  ...
                  if (code.length == 6) {
                    ...
                    LoadApp.toast(getTranslated(this.context, 'correctotp'));
                  }
                },
                onCodeChanged: (code) {
                  if (code!.length == 6) {
  ...
  Widget build(BuildContext context) {
    ...
    return LoadApp.getNTPWrappedWidget(Scaffold(
