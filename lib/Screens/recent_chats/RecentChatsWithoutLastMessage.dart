...
class RecentChatsWithoutLastMessageState
                ...
                return AlertDialog(
                  ...
                  actions: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        String chatId = LoadApp.getChatId(
                        ...
                        if (currentUserNo != null &&
                          ...
                          LoadApp.toast('Error Occured. Could not delete !');
                        }
                      },
                    )
                  ],
  ...
  Stream<MessageData> getUnread(Map<String, dynamic> user) {
    String chatId = LoadApp.getChatId(currentUserNo!, user[Dbkeys.phone]);
