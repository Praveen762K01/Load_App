...
import '../../Screens/contact_screens/SelectContactsToForward.dart';
...
import '../../Screens/chat_screen/utils/deleteChatMedia.dart';
...
import '../../Screens/chat_screen/utils/audioPlayback.dart';
import '../../Screens/chat_screen/utils/message.dart';
...
import '../../Services/Providers/seen_state.dart';
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  String decryptWithCRC(String input) {
    ...
    // LoadApp.toast(getTranslated(this.context, 'msgnotload'));
    return '';
  }
  ...
  readLocal(
    ...
    chatId = LoadApp.getChatId(currentUserNo!, peerNo!);
  ...
  Future uploadFile(bool isthumbnail, {int? timestamp}) async {
    ...
    if (isthumbnail == true) {
      ...
      await _mediaInfo.getMediaInfo(thumbnailFile.path).then((mediaInfo) {
        ...
        LoadApp.toast(getTranslated(this.context, 'failedsending'));
    ...
    if (content.trim() != '') {
      ...
      try {
        ...
        if (encrypted is String) {
          ...
          LoadApp.toast('Nothing to encrypt');
        }
      } on Exception catch (_) {
        // debugPrint('Exception caught!');
        LoadApp.toast("Exception: $_");
      }
    }
  }
          ...
          builder: (BuildContext popable) => ListTile(
              ...
              onTap: () async {
                ...
                await FirebaseFirestore.instance
                    ...
                    .then((chatDoc) async {
                  if (!chatDoc.exists) {
                    LoadApp.toast('Please reload this screen !');
              ...
              onTap: () async {
                ...
                if ((mssgDoc.containsKey(Dbkeys.isbroadcast) == true
                  ...
                  await deleteMsgMedia(mssgDoc, chatId!)
                      .then((isDeleted) async {
                    if (isDeleted == false || isDeleted == null) {
                      LoadApp.toast('Could not delete. Please try again!');
                    } else {
                      await FirebaseFirestore.instance
                          .collection(DbPaths.collectionmessages)
                          .doc(chatId)
      ...
      tiles.add(Builder(
          builder: (BuildContext popable) => ListTile(
              ...
              onTap: () {
                ...
                LoadApp.toast(getTranslated(popable, 'copied'));
                Navigator.of(popable).pop();
              })));
    }
    if (((mssgDoc[Dbkeys.from] == currentUserNo &&
    ...
    if (index >= list.length) {
      ...
      if (list[index].containsKey(Dbkeys.groupNAME)) {
        try {
          ...
          LoadApp.toast('Failed to send $e');
        }
      } else {
        try {
          ...
          if (encrypted is String) {
            ...
            LoadApp.toast('Nothing to send');
          }
        } catch (e) {
          setStateIfMounted(() {
            isgeneratingSomethingLoader = false;
          });
          LoadApp.toast('Failed to Forward message. Error:$e');
        }
      }
    }
  }
          ...
          ElevatedButton(
              ...
              onPressed: () async {
                ...
                if (isUser == null || isUser == false) {
                  LoadApp.toast(getTranslated(this.context, 'usernotjoined') +
                      ' $Appname');
                }
              },
                          ...
                          : observer.ismediamessagingallowed == true
                              ? textEditingController.text.length == 0
                                  ...
                                  : observer.istextmessagingallowed == false
                                      ? () {
                                          LoadApp.showRationale(getTranslated(
                                              this.context,
                                              'textmssgnotallowed'));
                                        }
                                      : chatStatus == ChatStatus.blocked.index
        ...
        for (final doc in docs.docs) {
          ...
          try {
            ...
            if (e.toString().contains('range')) {
              LoadApp.toast(getTranslated(this.context, 'failedtoloadchat'));
              Navigator.of(this.context).pop();
            }
          }
        }
...
//-- GROUP BY DATE ---
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
      prefs: widget.prefs,
      scaffold: LoadApp.getNTPWrappedWidget(WillPopScope(
                                            ...
                                            onSelected: (dynamic val) {
                                              switch (val) {
                                                                    ...
                                                                    myElevatedButton(
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          Map<String, dynamic>
                                                                            ...
                                                                            'id':
                                                                                LoadApp.getChatId(currentUserNo!, peerNo!),
                                                                          };
                                                ...
                                                case 'remove_wallpaper':
                                                  ...
                                                  // LoadApp.toast('Wallpaper removed.');
                                                  break;
                                                case 'set_wallpaper':
                                                  Navigator.push(
                                                      context,
  ...
  deleteAllChats() async {
    if (messages.length > 0) {
      LoadApp.toast(getTranslated(this.context, 'deleting'));
      await FirebaseFirestore.instance
          .collection(DbPaths.collectionmessages)
          .doc(chatId)
          .get()
