  ...
  void _stopCallingSound(context) async {
    if (_mPlayer != null) {
      try {
        ...
        LoadApp.toast("Failed to stop calling sound.  Error $e");
      }
    }
  }
    ...
    _engine.registerEventHandler(
      RtcEngineEventHandler(
        ...
        onUserJoined:
          ...
          // LoadApp.toast('joined - ${connection.localUid}');
          Wakelock.enable();
          flutterLocalNotificationsPlugin.cancelAll();
        },
        ...
        onTokenPrivilegeWillExpire: (RtcConnection connection, String token) {
          ...
          LoadApp.toast("Failed to Call. Please try calling again !");
          flutterLocalNotificationsPlugin.cancelAll();
        },
      ),
    );
                      ...
                      children: <Widget>[
                        _remoteUid == null
                            ...
                            : isuserenlarged
                                ? _localVideo()
                                : _remoteVideo(),
                        // onetooneview(context, screenHeight, screenWidth, false,
                        //     isuserenlarged),
                        _toolbar(context, false, 'calling'),
                        _panel(
                            context: context,
