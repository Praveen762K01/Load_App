...
import '../../Screens/status/StatusView.dart';
import '../../Screens/status/components/ImagePicker/image_picker.dart';
import '../../Screens/status/components/TextStatus/textStatus.dart';
import '../../Screens/status/components/VideoPicker/VideoPicker.dart';
import '../../Screens/status/components/circleBorder.dart';
import '../../Screens/status/components/formatStatusTime.dart';
import '../../Screens/status/components/showViewers.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final contactsProvider =
        Provider.of<SmartContactProviderWithLocalStoreData>(context,
            listen: true);
    return LoadApp.getNTPWrappedWidget(ScopedModel<DataModel>(
        model: widget.model!,
        child:
