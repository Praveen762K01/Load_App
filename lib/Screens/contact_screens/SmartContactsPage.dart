...
import '../../Screens/contact_screens/contacts.dart';
...
import '../../Screens/chat_screen/pre_chat.dart';
import '../../Screens/contact_screens/AddunsavedContact.dart';
...
class _SmartContactsPageState extends State<SmartContactsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: LoadApp.getNTPWrappedWidget(ScopedModel<DataModel>(
            model: widget.model,
                          ...
                          onPressed: () async {
                            final SmartContactProviderWithLocalStoreData
                                contactsProvider = Provider.of<
                                    ...
                                    context,
                                    listen: false);
                            LoadApp.toast(getTranslated(context, "loading"));
                                                                              ...
                                                                              if (sharedSecret != null && privateKey != null) {
                                                                                ...
                                                                                FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).collection(Dbkeys.lastSyncedContacts).doc(Dbkeys.lastSyncedContacts).set({
                                                                                  ...
                                                                                  FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).set({
                                                                                    ...
                                                                                    LoadApp.toast(getTranslated(this.context, 'syncsuccess'));
                                                                                  }).catchError((e) {
                                                                                    LoadApp.toast("${getTranslated(this.context, 'failedtosync')}\n\n $e");
                                                                                  });
                                                                                });
                                                                              } else {
                                                                                LoadApp.toast("Failed ! Please try again .");
                                                                              }
                                                                            } catch (e) {
                                                                              LoadApp.toast("${getTranslated(this.context, 'failedtosync')} \n\n- $e");
                                                                            }
                                                                              ...
                                                                              onPressed: () {
                                                                                ...
                                                                                FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).collection(Dbkeys.lastSyncedContacts).doc(Dbkeys.lastSyncedContacts).delete().then((value) {
                                                                                  FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).set({
                                                                                    ...
                                                                                    LoadApp.toast(getTranslated(this.context, 'syncdeleted'));
                                                                                  }).catchError((e) {
                                                                                    LoadApp.toast("Failed !\n\n $e");
                                                                                  });
                                                                                });
                                                                              },
                                                                              child: Text(
                                                                  ...
                                                                  if (wUser !=
                                                                    ...
                                                                    if (model.currentUser![Dbkeys.locked] !=
                                                                      ...
                                                                      ChatController.authenticate(
                                                                          ...
                                                                          state: Navigator.of(
                                                                              context),
                                                                          type: LoadApp.getAuthenticationType(
                                                                              widget
                                                                                  .biometricEnabled,
                                                                              model),
                                                                          onSuccess:
