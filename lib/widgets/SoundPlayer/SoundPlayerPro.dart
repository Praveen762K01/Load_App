...
class MultiPlayback extends StatefulWidget {
  ...
  final FlutterSoundPlayer? mPlayer1;
  MultiPlayback({this.url, this.isMe, this.onTapDownloadFn, this.mPlayer1});
  @override
...
class _MultiPlaybackState extends State<MultiPlayback> {
  ...
  void initState() {
    ...
    print("==========++++++==========xxxxx");
    audioPlayer.stop();
    if (widget.mPlayer1 != null) {
      _mPlayer1 = widget.mPlayer1;
    }
  ...
  void play1() async {
    try {
      ...
      LoadApp.toast('This message is deleted by sender');
    }
  }
