...
class _MultiImagePickerState extends State<MultiImagePicker> {
  ...
  Widget build(BuildContext context) {
    final observer = Provider.of<Observer>(this.context, listen: false);
    return LoadApp.getNTPWrappedWidget(WillPopScope(
      child: Scaffold(
            ...
            children: <Widget>[
              _buildActionButton(
                  ...
                  checkTotalNoOfFilesIfExceeded() == false
                      ? () {
                          LoadApp.checkAndRequestPermission(Permission.storage)
                              .then((res) {
                            if (res == true) {
              ...
              _buildActionButton(
                  ...
                  checkTotalNoOfFilesIfExceeded() == false
                      ? () {
                          LoadApp.checkAndRequestPermission(Permission.camera)
                              .then((res) {
                            if (res == true) {
